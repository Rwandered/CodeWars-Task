...
// the oldest living family member’ s age and the youngest family member’ s 
...
function differenceInAges(ages) {
  return [Math.min(...ages), Math.max(...ages), Math.round(Math.max(...ages) - Math.min(...ages))]
}

const ages = [10, 13, 4, 15, 45, 67, 89, 34, 11]
